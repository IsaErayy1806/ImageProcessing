#Üç ana tür bulanıklaştırma vardır
...
#Ortalama Bulanıklaştırma
#Çekirdek alanı altındaki tüm piksellerin ortalmasını alır ve bu ortalamayı merkezi öğe il e yer değiştirir

#Gauss Bulanıklaştırma
#Bu yöntmede kutu filtresi yerine Gauss çekirdeği kullanılır
#Pozitif ve tek olması gereken çekirdeğin genişliğini ve yüksekliğini belirtir

#Medyan Bulanıkkaştırma
#Çekirdek alanı altındaki tüm piksellerin medyanını alır
#Merkezi öğe bu medyan değerle değiştirilir.
#Tuz ve biber gürültüsüne karşı oldukça etkilidir
#Tuz ve biber siyah noktalar olarak adlandırılablir.
